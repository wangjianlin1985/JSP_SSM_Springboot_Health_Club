		       ...
		       text: "会员消费管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Xiaofei/xiaofei_add.jsp"
			    	   	},
			    		{
			    	   		text: "会员消费管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Xiaofei/xiaofei_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "员工工资管理",
			    	   ...
			    	   [
			    		{
			    	   		...
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Salary/salary_employeeQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "设备信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "DeviceClass/deviceClass_add.jsp"
			    	   	},
			    		{
			    	   		text: "设备类别管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "DeviceClass/deviceClass_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加设备",
			    		    state: "open",
		       ...
		       text: "设备维修管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "DeviceRepair/deviceRepair_add.jsp"
			    	   	},
			    		{
			    	   		text: "设备维修管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "DeviceRepair/deviceRepair_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: "Employee/employee_selfModify.jsp"
			    	   	}
			    	   ]
			}],
