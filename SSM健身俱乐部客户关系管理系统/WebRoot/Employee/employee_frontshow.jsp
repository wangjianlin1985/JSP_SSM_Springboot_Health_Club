...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=employee.getUserPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=employee.getEmail()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">员工档案变动:</div>
		<div class="col-md-10 col-xs-6"><%=employee.getEmployeeDesc()%></div>
	</div>
	<div class="row bottom15">
