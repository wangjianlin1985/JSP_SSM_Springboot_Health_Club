	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Employee/<%=employee.getEmployeeNo() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=employee.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		员工号:<%=employee.getEmployeeNo() %>
			     	</div>
			     	<div class="field">
	            		所在部门:<%=employee.getDepartmentObj().getDepartmentName() %>
			     	</div>
			     	<div class="field">
	            		姓名:<%=employee.getName() %>
			     	</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="employee_departmentObj_departmentNo_edit" class="col-md-3 text-right">所在部门:</label>
		  	 <div class="col-md-9">
			    <select id="employee_departmentObj_departmentNo_edit" name="employee.departmentObj.departmentNo" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="employee_userPhoto_edit" class="col-md-3 text-right">员工照片:</label>
		  	 <div class="col-md-9">
			    <img  class="img-responsive" id="employee_userPhotoImg" border="0px"/><br/>
			    <input type="hidden" id="employee_userPhoto" name="employee.userPhoto"/>
		  ...
		  <div class="form-group">
		  	 <label for="employee_employeeDesc_edit" class="col-md-3 text-right">员工档案变动:</label>
		  	 <div class="col-md-9">
			 	<textarea name="employee.employeeDesc" id="employee_employeeDesc_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		</form> 
...
<script>
//实例化编辑器
var employee_employeeDesc_edit = UE.getEditor('employee_employeeDesc_edit'); //员工档案变动编辑器
			...
			if (employee) {
				...
				$.ajax({
					...
					success: function(departments,response,status) { 
						$("#employee_departmentObj_departmentNo_edit").empty();
						var html="";
		        		$(departments).each(function(i,department){
		        			html += "<option value='" + department.departmentNo + "'>" + department.departmentName + "</option>";
		        		});
		        		$("#employee_departmentObj_departmentNo_edit").html(html);
		        		$("#employee_departmentObj_departmentNo_edit").val(employee.departmentObjPri);
					}
				});
				...
				$("#employee_userPhoto").val(employee.userPhoto);
				$("#employee_userPhotoImg").attr("src", basePath +　employee.userPhoto);
				...
				employee_employeeDesc_edit.setContent(employee.employeeDesc, false);
