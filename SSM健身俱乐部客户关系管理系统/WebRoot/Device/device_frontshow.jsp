...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Device/frontlist">设备信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">设备id:</div>
		<div class="col-md-10 col-xs-6"><%=device.getDeviceId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">设备类别:</div>
		<div class="col-md-10 col-xs-6"><%=device.getDeviceClassObj().getClassName() %></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=device.getPrice()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">设备库存:</div>
		<div class="col-md-10 col-xs-6"><%=device.getDeviceCount()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">设备位置:</div>
		<div class="col-md-10 col-xs-6"><%=device.getDevicePlace()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">发布时间:</div>
		<div class="col-md-10 col-xs-6"><%=device.getAddTime()%></div>
	</div>
	<div class="row bottom15">
