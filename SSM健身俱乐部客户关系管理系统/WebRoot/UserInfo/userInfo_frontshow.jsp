...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>UserInfo/frontlist">会员信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">职业:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getZhiye()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">生日:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getBirthDate()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">会员照片:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">健身目标:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getJsmb()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">健身习惯:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getJsxg()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">客户备注:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getKhbz()%></div>
	</div>
	<div class="row bottom15"> 
