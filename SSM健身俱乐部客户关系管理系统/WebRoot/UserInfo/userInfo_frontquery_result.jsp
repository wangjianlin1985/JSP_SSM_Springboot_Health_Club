...
<%
    ...
    String zhiye = (String)request.getAttribute("zhiye"); //职业查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">会员信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp" style="display:none;">添加会员</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<userInfoList.size();i++) {
            		...
            		UserInfo userInfo = userInfoList.get(i); //获取到会员对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		职业:<%=userInfo.getZhiye() %>
			     	</div>
			     	<div class="field">
	            		生日:<%=userInfo.getBirthDate() %>
			     	</div>
			     	<div class="field">
	            		联系方式:<%=userInfo.getTelephone() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="zhiye" name="zhiye" value="<%=zhiye %>" class="form-control" placeholder="请输入职业">
			</div>
			<div class="form-group">
				<label for="birthDate">生日:</label>
				<input type="text" id="birthDate" name="birthDate" class="form-control"  placeholder="请选择生日" value="<%=birthDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_zhiye_edit" class="col-md-3 text-right">职业:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_zhiye_edit" name="userInfo.zhiye" class="form-control" placeholder="请输入职业">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userPhoto_edit" class="col-md-3 text-right">会员照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_telephone_edit" class="col-md-3 text-right">联系方式:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_telephone_edit" name="userInfo.telephone" class="form-control" placeholder="请输入联系方式">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="userInfo_email_edit" class="col-md-3 text-right">Email:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_email_edit" name="userInfo.email" class="form-control" placeholder="请输入Email">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_jsmb_edit" class="col-md-3 text-right">健身目标:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_jsmb_edit" name="userInfo.jsmb" rows="8" class="form-control" placeholder="请输入健身目标"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="userInfo_jsxg_edit" class="col-md-3 text-right">健身习惯:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_jsxg_edit" name="userInfo.jsxg" rows="8" class="form-control" placeholder="请输入健身习惯"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="userInfo_khbz_edit" class="col-md-3 text-right">客户备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_khbz_edit" name="userInfo.khbz" rows="8" class="form-control" placeholder="请输入客户备注"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_zhiye_edit").val(userInfo.zhiye);
				...
				$("#userInfo_jsmb_edit").val(userInfo.jsmb);
				$("#userInfo_jsxg_edit").val(userInfo.jsxg);
				$("#userInfo_khbz_edit").val(userInfo.khbz);
