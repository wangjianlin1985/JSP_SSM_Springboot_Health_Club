...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">健身俱乐部网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!--
               <li><a href="<%=basePath %>UserInfo/frontlist">会员</a></li>
               <li><a href="<%=basePath %>Salary/frontlist">员工工资</a></li>
               <li><a href="<%=basePath %>Xiaofei/frontlist">会员消费</a></li> 
                -->
                 
                <li><a href="<%=basePath %>Department/frontlist">部门查询</a></li>
                <li><a href="<%=basePath %>Employee/frontlist">员工查询</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">投诉建议</a></li>
                <li><a href="<%=basePath %>DeviceClass/frontlist">设备类别</a></li>
                <li><a href="<%=basePath %>Device/frontlist">设备查询</a></li>
                <li><a href="<%=basePath %>DeviceRepair/frontlist">设备维修</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Xiaofei/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的消费记录</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;提交投诉建议</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的投诉建议</a></li>
