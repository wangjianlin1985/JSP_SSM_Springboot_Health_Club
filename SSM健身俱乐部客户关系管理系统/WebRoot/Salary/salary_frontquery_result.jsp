...
<%
    ...
    String getDate = (String)request.getAttribute("getDate"); //发放日期查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#salaryListPanel" aria-controls="salaryListPanel" role="tab" data-toggle="tab">员工工资列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Salary/salary_frontAdd.jsp" style="display:none;">添加员工工资</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>工资id</td><td>工资年份</td><td>工资月份</td><td>工资金额</td><td>发放员工</td><td>发放日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<salaryList.size();i++) {
					    	            		...
					    	            		Salary salary = salaryList.get(i); //获取到员工工资对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="salaryQueryForm" id="salaryQueryForm" action="<%=basePath %>Salary/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="employeeObj_employeeNo">发放员工：</label>
			...
			<div class="form-group">
				<label for="getDate">发放日期:</label>
				<input type="text" id="getDate" name="getDate" class="form-control"  placeholder="请选择发放日期" value="<%=getDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;员工工资信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="salary_employeeObj_employeeNo_edit" class="col-md-3 text-right">发放员工:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="salary_getDate_edit" class="col-md-3 text-right">发放日期:</label>
		  	 <div class="col-md-9">
                <div class="input-group date salary_getDate_edit col-md-12" data-link-field="salary_getDate_edit"  data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="salary_getDate_edit" name="salary.getDate" size="16" type="text" value="" placeholder="请选择发放日期" readonly>
	...
	$.ajax({
		...
		success : function (salary, response, status) {
			if (salary) {
				...
				$("#salary_getDate_edit").val(salary.getDate);
...
$(function(){
    ...
    /*发放日期组件*/
    $('.salary_getDate_edit').datetimepicker({
    	language:  'zh-CN',  //语言
    	format: 'yyyy-mm-dd',
    	minView: 2,
    	weekStart: 1,
