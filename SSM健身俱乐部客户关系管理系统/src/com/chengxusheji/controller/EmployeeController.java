...
public class EmployeeController extends BaseController {
	...
	public void add(@Validated Employee employee, BindingResult br,
		...
		try {
			employee.setUserPhoto(this.handlePhotoUpload(request, "userPhotoFile"));
	...
	public void update(@Validated Employee employee, BindingResult br,
		...
		if(!userPhotoFileName.equals("upload/NoImage.jpg"))employee.setUserPhoto(userPhotoFileName); 
	...
	public void OutToExcel(String employeeNo,@ModelAttribute("departmentObj") Department departmentObj,String name,String birthDate,String telephone, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "员工号","所在部门","姓名","性别","出生日期","员工照片","联系电话","邮箱"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<employeeList.size();i++) {
        	Employee employee = employeeList.get(i); 
        	dataset.add(new String[]{employee.getEmployeeNo(),employee.getDepartmentObj().getDepartmentName(),employee.getName(),employee.getGender(),employee.getBirthDate(),employee.getUserPhoto(),employee.getTelephone(),employee.getEmail()});
        }
        /*
