...
public class EmployeeService {
    ...
    public ArrayList<Employee> queryEmployee(String employeeNo,Department departmentObj,String name,String birthDate,String telephone,int currentPage) throws Exception { 
    	...
    	if(null != departmentObj &&  departmentObj.getDepartmentNo() != null  && !departmentObj.getDepartmentNo().equals(""))  where += " and t_employee.departmentObj='" + departmentObj.getDepartmentNo() + "'";
	...
	public boolean checkLogin(Admin admin) throws Exception { 
		Employee db_emp = (Employee) employeeMapper.getEmployee(admin.getUsername());
		if(db_emp == null) { 
			this.errMessage = " 账号不存在 ";
			System.out.print(this.errMessage);
			return false;
		} else if( !db_emp.getPassword().equals(admin.getPassword())) {
