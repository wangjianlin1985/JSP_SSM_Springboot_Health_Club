...
public class UserInfoService {
    ...
    /*按照查询条件分页查询会员记录*/
    public ArrayList<UserInfo> queryUserInfo(String user_name,String name,String zhiye,String birthDate,String telephone,int currentPage) throws Exception { 
    	...
    	if(!zhiye.equals("")) where = where + " and t_userInfo.zhiye like '%" + zhiye + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<UserInfo> queryUserInfo(String user_name,String name,String zhiye,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(!name.equals("")) where = where + " and t_userInfo.name like '%" + name + "%'";
    	if(!zhiye.equals("")) where = where + " and t_userInfo.zhiye like '%" + zhiye + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String user_name,String name,String zhiye,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(!name.equals("")) where = where + " and t_userInfo.name like '%" + name + "%'";
    	if(!zhiye.equals("")) where = where + " and t_userInfo.zhiye like '%" + zhiye + "%'";
